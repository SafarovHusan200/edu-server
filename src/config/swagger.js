...
const definition = {
  ...
  tags: [
    ...
    { name: 'DailySpin', description: "Kunlik barabon (streak va diamond yutuqlari)" },
  ],
  components: {
    securitySchemes: {
      bearerAuth: {
    ...
    schemas: {
      ...
      Reward: {
        ...
        properties: {
          ...
          isActive: { type: 'boolean' },
          premiumOnly: { type: 'boolean', description: "true bo'lsa faqat premium studentlar almashtira oladi" },
          ...timestamps,
        },
      },
      RewardRedemption: {
        type: 'object',
        description: "Bosqichlar: pending → approved → delivered (yoki pending/approved → rejected)",
        properties: {
          _id: idProp,
          student: { oneOf: [idProp, { $ref: '#/components/schemas/User' }] },
          ...
          approvedBy: { oneOf: [idProp, { $ref: '#/components/schemas/User' }], nullable: true },
          approvedAt: { type: 'string', format: 'date-time', nullable: true },
          rejectedBy: { oneOf: [idProp, { $ref: '#/components/schemas/User' }], nullable: true },
          rejectedAt: { type: 'string', format: 'date-time', nullable: true },
          rejectReason: { type: 'string' },
          deliveredBy: { oneOf: [idProp, { $ref: '#/components/schemas/User' }], nullable: true },
